<tr>
  <td>
    <table style="width:100%" border="0" cellspacing="0" cellpadding="0"
           background="<?php echo e(asset('images/footer.jpg')); ?>">
      <tr>
        <td align="center">
          <img src="<?php echo e(asset('images/goggen.jpg')); ?>" border="0">
          <span style="color:#0000FF;">จำนวนผู้เข้าชมเว็บที่สะสม <?php echo e($visitorCount ?? 0); ?> คน</span>
        </td>
      </tr>
      <tr>
        <td align="center">
